...
from solver.model import build_constraints, build_objective
...
class HFFVRPTWProblem(BaseProblemInstance):
    def read_instance(self, filename: str=None):
        ...
        # --- Processamento de Vértices e Clientes ---
        ...
        # --- Processamento de Arestas, Distâncias e Tempos ---
        ...
        # --- Impressão de Verificação (Substituindo as antigas) ---
    ...
    def write_results(self, filename: str, sol: BaseSolution):
...
class HFFVRPTWEvaluator(BaseEvaluator):
    ...
    def constraints(self, sol: BaseSolution):
        return build_constraints(self.problem, sol)
        

    def objective_function(self, sol: BaseSolution):
